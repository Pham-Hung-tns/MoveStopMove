...
public class BulletSpawner : MonoBehaviour
{
    ...
    {
        GameObject bullet = Pooling.instance._PullResources(gameObject.tag, GetPath(gameObject.tag));
        Bullet _bullet = CacheComponents<Bullet>.Get(bullet);
        _bullet.Render.sharedMaterials = _bulletMaterial;
