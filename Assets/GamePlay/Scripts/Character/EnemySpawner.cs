...
public class EnemySpawner : MonoBehaviour, IInitializeVariables
{
    ...
    { BottomLeft, BottomRight, UpLeft, UpRight }
    ...
    private void FindAreaToSpawn()
    {
        ...
        if (GameManager.Instance.IsAliveAmount < CharacterOnMapAmount && SpawnAmount > 0)
        {
            ...
            {
                GameObject gob = Pooling.instance._PullResources("Enemy", "Prefabs/Enemy");
    ...
    #endregion Find the Area to Spawn Enemy
}